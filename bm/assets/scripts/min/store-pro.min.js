...
( function ( document, $, undefined ) {
	...
	$( '.site-header > .wrap' ).append( '<button class="fal fa-search search-toggle" role="button"><span class="screen-reader-text">Toggle search</span></button><button class="menu-toggle" role="button" type="button"><span>Toggle Menu</span></button>' );
	
	//Custom icons
	$( '.site-header > .wrap' ).append('<a href="/my-account/" class="header-profile"><i class="fal fa-user-alt"></i></a>');
	
	//CTA button
	$( '.site-header > .wrap' ).append('<a href="tel:561-440-9000" class="link-call">561-440-9000</a>');
